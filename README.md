...
Новые функции и заметные улучшения публикуются в отдельной открытой ленте. Из каждого обновления автоматически формируются рекламные черновики для Дзена и MAX.

- 🆕 [Все обновления БАЗИС](updates/README.md)
- ✍️ [Контент для Дзена и MAX](distribution/README.md)
- ⚙️ [Как работает автоматическая публикация](docs/PUBLISHING.md)

Публичный процесс получает только специально подготовленное описание изменения и не читает исходный код закрытых репозиториев.
